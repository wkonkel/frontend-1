with (Hasher('About', 'Application')) {
  ...
  define('about_company', function() {
    return div({ 'class': 'bio', id: 'company' },
      ...
      p("Domains effectively drive the entire internet, shouldn't they be easier to manage? We thought so, and thus, Badger was born! You shouldn't have to auction off your house and sacrifice your first born son to transfer domains, you should be able to press a button that says \"Transfer Domain\" and be done with it. That is our philosophy, and we think you will appreciate it."),
      p("Stop letting domain registrars badger you! Err, you can let us badger you, but it will be a pleasant badgering!"),
