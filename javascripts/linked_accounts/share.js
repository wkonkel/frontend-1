...
//   
//   route('#domains/:domain_name/share', function() {
...
//         info_message(
//           h3('Link an Account'),
//           p('If you have a Facebook or Twitter account linked, you can take this opportunity to share your recent domain acquisition with friends.')
//         )
//       ),
//       
//       target_div
...
//         div(
//           h2('Link an Account'),
//           LinkedAccounts.add_linked_account_icons({ size: 'small' }, 'facebook', 'twitter')
//         ),
//         div('fdsa')
//       );
//     });
